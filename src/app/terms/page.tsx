        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-text-secondary">
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>
                通常予約のキャンセル期限は、各加盟店が設定した期限に従い、加盟店がキャンセル期限を設定していない場合は、予約時刻の24時間前までとします。
              </li>
              <li>
                通常予約（来店払い）について、無料キャンセル期限（予約時刻の24時間前。加盟店が別途期限を定めている場合はその期限）を過ぎたキャンセル、当日キャンセルまたは無断キャンセル（ノーショー）の場合、各加盟店が当該予約に現に生ずる平均的な損害の額の範囲内で定める額（上限は当該予約のメニュー価格）のキャンセル料が発生することがあります。当社は、加盟店に代わり当該キャンセル料を請求・回収する代行業務のみを行い、キャンセル料は加盟店に帰属します。消費者契約法第9条第1号に基づき、加盟店に現に生ずる平均的な損害の額を超える部分は無効であり、当社・加盟店はこれを請求しません。
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>
                トレード成立時、当社は購入者が支払うトレード価格に対して当社所定の料率の手数料を収受します。当該手数料は、購入者が支払うトレード価格の中から当社・加盟店・出品者に分配されるものであり、購入者がトレード価格に上乗せして負担するものではありません。
              </li>
